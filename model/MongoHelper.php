...
class MongoHelper {
	...
	public function __construct() {
		...
		$this->mongo = $mongo->{clConfig::get("database_name")};
		
		// authentication
		if (clConfig::get("database_username") !== "" && clConfig::get("database_password") !== "")
		{
			$this->authenticate(clConfig::get("database_username"), clConfig::get("database_password"));
		}
